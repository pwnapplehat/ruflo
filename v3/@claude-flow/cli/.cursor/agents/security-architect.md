...
# CVE-specific checks
npx ruflo@latest security cve --check CVE-2024-001
npx ruflo@latest security cve --check CVE-2024-002
npx ruflo@latest security cve --check CVE-2024-003

# Threat modeling
npx ruflo@latest security threats --methodology STRIDE
npx ruflo@latest security threats --methodology DREAD

# Audit report
npx ruflo@latest security audit --output-format markdown

# Validate security configuration
npx ruflo@latest security validate --config ./security.config.json

# Generate security report
npx ruflo@latest security report --format pdf --include-remediations
```
