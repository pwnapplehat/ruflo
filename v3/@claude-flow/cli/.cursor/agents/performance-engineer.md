...
npx ruflo@latest performance profile --component mcp-server

# Analyze bottlenecks
npx ruflo@latest performance analyze --target latency

# Generate performance report
npx ruflo@latest performance report --format detailed

# Optimize specific area
npx ruflo@latest performance optimize --focus memory

# Real-time metrics
npx ruflo@latest status --metrics --watch

# WASM SIMD benchmark
npx ruflo@latest performance benchmark --suite wasm-simd

# Flash attention benchmark
npx ruflo@latest performance benchmark --suite flash-attention

# Memory reduction analysis
npx ruflo@latest performance analyze --target memory --quantization int8
```
