...
const DATA_DIR = path.join(process.cwd(), '.cursor-flow', 'data');
const STORE_PATH = path.join(DATA_DIR, 'auto-memory-store.json');
const RANKED_PATH = path.join(DATA_DIR, 'ranked-context.json');
const PENDING_PATH = path.join(DATA_DIR, 'pending-insights.jsonl');
const SESSION_DIR = path.join(process.cwd(), '.cursor-flow', 'sessions');
const SESSION_FILE = path.join(SESSION_DIR, 'current.json');

// â”€â”€ Safety limits (fixes #1530, #1531) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
var MAX_DATA_FILE_SIZE = 10 * 1024 * 1024; // 10 MB â€” skip files larger than this
...
// â”€â”€ Truncation transparency (FIX 4) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Deduplication helper (fixes #1518) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function bootstrapFromMemoryFiles() {
  ...
  // kept ':' and '\\' and never matched the real ~/.claude/projects/<slug> dir â€”
  ...
  var candidates = [
    ...
    path.join(process.cwd(), ".cursor-flow", "memory"),
