...
// Helpers (router.cjs, session.cjs, memory.cjs, intelligence.cjs) live at
// <project>/.cursor-flow/helpers/ — a sibling of .cursor/, NOT a child.
// From .cursor/hooks/, that's up two levels then into .cursor-flow/helpers.
